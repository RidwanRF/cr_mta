...
function toggleMoveControls(val)
    toggleControl("fire", val)
    toggleControl("jump", val)
    toggleControl("sprint", val)
    toggleControl("enter_exit", val)
    toggleControl("crouch", val)
    toggleControl("action", val)
end
...
addEventHandler("stopDoingAmbulanceBed", localPlayer,
    function(ignore)
        ...
        localPlayer:setData("char >> bone", bone)
        if ignore then

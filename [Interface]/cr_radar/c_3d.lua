...
function render3DBlips()
    ...
    for name, data in pairs(renderCache) do
        ...
        if sx and sy then
            ...
            dxDrawText("#33ff33".. dist2 .. "#ffffff méter", sx, sy + (15 * multipler), sx, sy + (15 * multipler), tocolor(255, 255, 255, alpha), multipler, font, "center", "center", false, false, false, true)
        end
    end
end

questions = {
    ...
    {"Mikor használjuk a /me parancsot?", "Mikor láthatatlan cselekvést akarunk kifejezni", "Mikor látható cselekményt akarunk kifejezni írásban", "Mikor gondolatmenetet akarunk kifejezni", "Fogalmam sincs", 1},
    ...
    --{"Egy játékosra hárman ráfogjuk a fegyvert, de ő elszalad. Mit követ el ilyenkor?", "MetaGaming", "RevengeKill", "SpawnKill", "PowerGaming", 4},
    --{"Mit jelent a WK rövidítés?", "WishKill", "WriteKill", "Nincs jelentése", "WonderKill", 2},
    --{"Mit jelent a HK rövidítés?", "Magas karakter", "Nincs jelentése", "Helikopterrel való ölés",  "Fogalmam sincs", 3},
    ...
    {"Egy fegyvert szeretnél eladni. Hogyan teszed meg?", "Kiállok egy forgalmas helyre és kiabálok, hogy fegyver eladó", "Burkolt formában hirdetést adok fel", "Városházán megpróbálok házalni vele",  "Nem tudom", 2},
    {"Szeretnél egy illegális bűnszervezethez (maffiához) csatlakozni. Hogyan teszed meg?", "Odamegyek a HQ-ra és közlöm, hogy csatlakozni akarok a maffiához", "Megkeresem a tagok nevét TS-n majd a szerveren felkeresem őket", "Feladok egy hirdetést, hogy maffiába szeretnék csatlakozni",  "Várok, hogy hirdessenek valamiféle munkát, majd jelentkezek rá és fokozatosan lépek előre", 4},
    {"Szeretnél a rendőrség tagja lenni. Miként tudsz csatlakozni?", "Várok, hogy munkát hirdessenek. Ha lesz felvétel akkor jelentkezek", "Megkérek egy admint, hogy rakjon a frakcióba", "TS-n felkeresem a leadert és berakatom magam a frakcióba",  "Megkérem a barátom, hogy vetessen fel engem", 1},
    ...
    {"Nem akarsz játszani a szerveren, de továbbadnál a cuccaidon. Hogy teheted meg?", "Eladom őket CS:GO skinekért", "Odaadom egy barátomnak a szerveren", "Eladom valamelyik facebook csoportban",  "Elcserélem más játékból származó tárgyakra", 2},
    {"A szerveren milyen játékmód folyik?", "Prison break", "Play", "Szerepjáték azaz RolePlay",  "PUBG", 3},

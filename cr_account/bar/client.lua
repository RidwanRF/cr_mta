        ...
        if guiState and s then
            ...
            if now == "Char-Reg.Name" then
                ...
                elseif subWord[b] or b2 == " \ " then
                    exports["cr_infobox"]:addBox("warning", "A nevedben nem szerepelhet ékezet!")
                    return
                elseif tonumber(b) then
                    exports["cr_infobox"]:addBox("warning", "A nevedben nem szerepelhet szám!")
                    return
                end
            end

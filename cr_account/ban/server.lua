...
function obanPlayer(thePlayer, cmd, target, time, ...)
    if exports['cr_permission']:hasPermission(thePlayer, "oban") then
        ...
        if target then
            ...
            local banText2 = string.gsub(banText, "#" .. (6 and string.rep("%x", 6) or "%x+"), "")
            triggerEvent("showAdminBox",thePlayer, "#ff751a" .. aName.." #ffffffkitiltotta #ff751a"..targetName.."#ffffff-at/et a szerverről! #ff751a[Offline]#ffffff\n#ff751aIndok:#ffffff "..reason.."\n"..banText, "error", {text .. " [Offline]", "Indok: "..text2, banText2})
            local time = exports['cr_core']:getTime() .. " "
            local text = string.gsub(text, aName, (tonumber(getElementData(thePlayer, "acc >> id")) or inspect(thePlayer)))
...
function ucpBan(accID, adminName, accID2, aLevel)
    ...
    if target then
        ...
        local banText2 = string.gsub(banText, "#" .. (6 and string.rep("%x", 6) or "%x+"), "")
        triggerEvent("showAdminBox",getRandomPlayer(), "#ff751a" .. aName.." #ffffffkitiltotta #ff751a"..targetName.."#ffffff-at/et a szerverről! #ff751a[Offline]#ffffff\n#ff751aIndok:#ffffff "..reason.."\n"..banText, "error", {text .. " [Offline]", "Indok: "..text2, banText2})
        local time = exports['cr_core']:getTime() .. " "

...
local editorFont = dxCreateFont("editor/files/Roboto.ttf", 8, false, "antialiased")
...
addEventHandler("onClientRender", getRootElement(),
	function ()
		...
		dxDrawImage(endXX - iconHalfSize, endXY - iconHalfSize, iconSize, iconSize, "editor/files/" .. editorTable["currentMode"] .. ".png")
		dxDrawImage(endYX - iconHalfSize, endYY - iconHalfSize, iconSize, iconSize, "editor/files/" .. editorTable["currentMode"] .. ".png")
		dxDrawImage(endZX - iconHalfSize, endZY - iconHalfSize, iconSize, iconSize, "editor/files/" .. editorTable["currentMode"] .. ".png")
		...
		if not editorTable["activeAxis"] then
			for i = 1, #editorMenu do
				...
				dxDrawImage(iconX, iconY, iconSize, iconSize, "editor/files/" .. editorMenu[i][1] .. ".png")

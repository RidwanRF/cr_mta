...
function enableDoF()
	...
	dBlurHShader,tecName = dxCreateShader( "files/shaders/dof/fx/dBlurH.fx" )

	dBlurVShader,tecName = dxCreateShader( "files/shaders/dof/fx/dBlurV.fx" )
	
	dDepthTexShader,tecName = dxCreateShader( "files/shaders/dof/fx/dDepthTex.fx" )
...
addEventHandler( "onClientHUDRender", root,
    function()
			if not bAllValid or not Settings.var or not myScreenSource then return end
			local v = Settings.var	

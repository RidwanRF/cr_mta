...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('files/shaders/hdtexture/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('files/shaders/hdtexture/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('files/shaders/hdtexture/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('files/shaders/hdtexture/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('files/shaders/hdtexture/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('files/shaders/hdtexture/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('files/shaders/hdtexture/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('files/shaders/hdtexture/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('files/shaders/hdtexture/detail35T.png', "dxt3")
	...
	if not btAllValid then
        ...
        local v = "cj_sprunk_dirty"
        texElement = dxCreateTexture(":cr_texture/files/"..v..".png", textureQuality or "dxt1")
        local shadElement = dxCreateShader(":cr_texture/files/replace.fx", 0, 100, false, "all")
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "files/shaders/hdtexture/detail.fx", 1, 100 )
	if shader then

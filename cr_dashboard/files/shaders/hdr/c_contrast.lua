...
function enableContrast()
	...
	-- Shaders
	contrastShader = dxCreateShader( "files/shaders/hdr/fx/contrast.fx" )
	bloomCombineShader = dxCreateShader( "files/shaders/hdr/fx/bloom_combine.fx" )
	bloomExtractShader = dxCreateShader( "files/shaders/hdr/fx/bloom_extract.fx" )
	blurHShader = dxCreateShader( "files/shaders/hdr/fx/blurH.fx" )
	blurVShader = dxCreateShader( "files/shaders/hdr/fx/blurV.fx" )
	modulationShader = dxCreateShader( "files/shaders/hdr/fx/modulation.fx" )
	...
	-- Overlay texture
	textureVignette = dxCreateTexture ( "files/shaders/hdr/images/vignette1.dds" );

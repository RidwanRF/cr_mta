...
function startCarPaintReflect()
		...
		setcpRLffectVehicle()
		-- Create shader
		paintShader = dxCreateShader ( "files/shaders/carreflect/fx/car_paint.fx",1 ,v.renderDistance ,false, "vehicle" )
		glassShader = dxCreateShader ( "files/shaders/carreflect/fx/car_glass.fx",1 ,v.renderDistance ,false, "vehicle" )
		shatterShader = dxCreateShader ( "files/shaders/carreflect/fx/car_shatt.fx",1 ,v.renderDistance ,false, "vehicle" )		
		if paintShader and glassShader and shatterShader then
			...
			-- Set textures
			textureVol = dxCreateTexture ( "files/shaders/carreflect/images/smallnoise3d.dds" )

                        ...
                        if not disabledType[getVehicleType(element)] then
                            ...
                            if getElementAlpha(element) == 255 and dim1 == dim2 and int1 == int2 then
                                ...
                                if line then
                                    ...
                                    if getVehiclePlateText(element) then
            ...
            if getKeyState("J") then
                ...
                if veh then
                    ...
                    if getPedOccupiedVehicleSeat(localPlayer) == 0 then
                        ...
                        local newValue = not oldValue;
                        if newValue then
                            local hasKey = exports['cr_inventory']:hasItem(localPlayer, keyItem, getElementData(veh, "veh >> id")) or true;
                            ...
                            elseif getElementData(veh, "veh >> engineBroken") then
                                local vehicleName = getVehicleName(veh);
                                local syntax = exports['cr_core']:getServerSyntax(false, "error");
                    ...
                    if veh then
                        if not getElementData(veh, "veh >> locked") then
                            if not getElementData(target, "char >> belt") then
                                ...
                                triggerServerEvent("kickPlayerFromVeh", localPlayer, target);
